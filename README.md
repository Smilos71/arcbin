# 💾 Welcome to Arcbin!
## ❓ What is Arcbin?
- Arcbin is a non-commercial project dedicated to preserving digital history. We index and store old software, games, and drivers that are no longer supported or available through official channels.
## 📁 Categories
- [Games](./archive/games)
- [Programs](./archive/programs)
- [ISO files](./archive/ISO%20files)
